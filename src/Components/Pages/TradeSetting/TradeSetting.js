...
const TradeSetting = () => {
    ...
    useEffect(() => {
        fetch(`https://gffex.xyz/api/admin/trade/setting/view`, {
            method: 'GET',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleDelete = id => {
        fetch(`https://gffex.xyz/api/admin/trade/setting/delete/${id}`, {
            method: 'DELETE',
            headers: {
    ...
    const handleSubmitData = event => {
        ...
        axios.post(`https://gffex.xyz/api/admin/trade/setting/store`, userData, config)
            .then(response => {
                event.target.reset();
                setShow(false)
