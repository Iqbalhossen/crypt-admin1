                                    ...
                                    <div className=" col-md-8 ">
                                        <div className="col-md-12">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" name="title" onBlur={handleInputBlur} placeholder='Title' required id="heading" />
                                            </div>
                                        </div>
                                    </div>
