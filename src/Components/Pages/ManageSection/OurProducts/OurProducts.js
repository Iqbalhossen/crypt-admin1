...
const OurProducts = () => {
    ...
    const handleTitleSubmitData = event => {
        ...
        fetch(`https://gffex.xyz/api/admin/home/our/products/title/store`, {
            method: 'POST',
            headers: {
    ...
    useEffect(() => {
        fetch(`https://gffex.xyz/api/frontend/home/our/products/title/view`, {
            method: 'GET',
        })
            .then((res) => res.json())
    ...
    useEffect(() => {
        fetch(`https://gffex.xyz/api/frontend/home/our/products/view`, {
            method: 'GET',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleDelete = id => {
        fetch(`https://gffex.xyz/api/admin/home/our/products/delete/${id}`, {
            method: 'DELETE',
            headers: {
                'content-type': 'application/json',
            },
