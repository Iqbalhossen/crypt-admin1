...
const OurProductsEdit = () => {
    ...
    const handleSubmitData = event => {
        ...
        if (userData.ourproducts_img === '') {
            ...
            axios.put(`http://66.29.142.198:5000/api/admin/home/our/products/update/${id}`, userData, config)
                .then(response => {
                    event.target.reset();
    ...
    useEffect(() => {
        fetch(`http://66.29.142.198:5000/api/admin/home/our/products/edit/${id}`, {
            method: 'GET',
        })
            .then((res) => res.json())
            .then((data) => {
                                                ...
                                                <div className="thumb">
                                                    <div className="avatar-preview">
                                                        <div className="profilePicPreview" style={{ height: '120px', width: '100%' }}>
                                                            <img src={`http://66.29.142.198:5000/${data?.image_url}`} style={{ width: '100%', height: '120px' }} alt="" />
                                                        </div>
                                                    </div>
