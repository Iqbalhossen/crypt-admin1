...
const CommunityBtnEdit = () => {
    ...
    useEffect(() => {
        fetch(`http://66.29.142.198:5000/api/admin/home/community/button/edit/${id}`, {
            method: 'GET',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleSubmitData = event => {
        ...
        if (userData.community_btn_img === '') {
            ...
            axios.put(`http://66.29.142.198:5000/api/admin/home/community/button/update/${id}`, userData, config)
            .then(response => {
                event.target.reset();
                                                ...
                                                <div className="thumb">
                                                    <div className="avatar-preview">
                                                        <div className="profilePicPreview" style={{ height: '120px', width: '100%' }}>
                                                            <img src={`http://66.29.142.198:5000/${data?.btn_image}`} style={{ width: '100%', height: '120px' }} alt="" />
                                                        </div>
                                                    </div>
