...
const ManualGateways = () => {
    ...
    useEffect(() => {
        fetch(`http://66.29.142.198:5000/api/admin/gateway/manual/view`, {
            method: 'GET',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleDelete = id => {
        fetch(`http://66.29.142.198:5000/api/admin/gateway/manual/delete/${id}`, {
            method: 'DELETE',
            headers: {
    ...
    const handleEnableDisabled = id => {
        fetch(`http://66.29.142.198:5000/api/admin/gateway/manual/enable/disable/${id}`, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json',
            },
