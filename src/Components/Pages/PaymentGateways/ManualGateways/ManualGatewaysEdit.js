...
const ManualGatewaysEdit = () => {
    ...
    const handleSubmitData = event => {
        ...
        const storeData = { ...dataVulue, DepositInstruction:content}
        const config = {
            headers: {
                'content-type': 'application/json',
            }
        };
        axios.put(`https://gffex.xyz/api/admin/gateway/manual/update/${id}`, storeData, config)
            .then(response => {
                event.target.reset();
    ...
    return (
        <>
           <div className="d-flex mb-30 flex-wrap gap-3 justify-content-between align-items-center">
                <h6 className="page-title">Edit Manual Gateway</h6>
                <div className="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
                    <Link to="/admin/gateway/manual" className="btn btn-sm btn-outline-primary">
                                    ...
                                    <div className="payment-method-body">
                                        <div className="row mb-none-15">
                                            <div className="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                                <div className="form-group">
                                                    <label htmlFor="name" className="required">Gateway Name</label>
                                                    <input type="text" className="form-control " name="GatewayName" onBlur={handleInputBlur} required="" id="name" />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-12">
                                                <div className="card border--primary mt-3">
                                                    <h5 className="card-header bg-primary">Deposit Instruction</h5>
                                                    <div className="card-body">
                                                        <JoditEditor
                                                            ref={editor}
                                                            value={content}
...
export default ManualGatewaysEdit;