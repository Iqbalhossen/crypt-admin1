...
const WinTradeLogHistory = () => {
    const {id} = useParams();
    const [data, setData] = useState([]);
    useEffect(() => {
        fetch(`http://66.29.142.198:5000/api/admin/user/trade/log/win/${id}`, {
            method: 'GET',
        })
            .then((res) => res.json())
            .then((data) => {
    ...
    return (
        <>
            ...
            <div className="d-flex mb-30 flex-wrap gap-3 justify-content-between align-items-center">
                <h6 className="page-title">Win Trade Log</h6>
...
export default WinTradeLogHistory;